## Projects for ALX low level programming projects
File 0-preprocessor - Script that runs a C file through the preprocessor and saves the result into another file
